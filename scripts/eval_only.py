...
def _register_builtins() -> None:
    ...
    try:
        ...
        pass
    try:
        # harness-opt local adapter: see configs/docvqa-local/default.yaml
        from harness_example.docvqa.adapter import DocVQAAdapter as _DocVQALocalAdapter
        _ENV_REGISTRY["docvqa-local"] = _DocVQALocalAdapter
    except ImportError:
        pass
    try:
        # harness-opt local adapter: see configs/searchqa-local/default.yaml
        from harness_example.searchqa.adapter import SearchQAAdapter as _SearchQALocalAdapter
        _ENV_REGISTRY["searchqa-local"] = _SearchQALocalAdapter
    except ImportError:
        pass
    try:
        # harness-opt local adapter: see configs/spreadsheetbench-local/default.yaml
        from harness_example.spreadsheetbench.adapter import SpreadsheetBenchAdapter as _SpreadsheetBenchLocalAdapter
        _ENV_REGISTRY["spreadsheetbench-local"] = _SpreadsheetBenchLocalAdapter
    except ImportError:
        pass
    try:
        # harness-opt local adapter: see configs/livemath-local/default.yaml
        from harness_example.livemath.adapter import LiveMathematicianBenchAdapter as _LiveMathLocalAdapter
        _ENV_REGISTRY["livemath-local"] = _LiveMathLocalAdapter
    except ImportError:
        pass
    try:
