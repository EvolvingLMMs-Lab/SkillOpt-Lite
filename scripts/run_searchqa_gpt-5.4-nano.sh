#!/usr/bin/env bash
# ──────────────────────────────────────────────────────────────────────────────
# SkillOpt — searchqa training (target=gpt-5.4-nano, optimizer=gpt-5.5 by default)
#
# Thin wrapper over scripts/run_searchqa.sh that sets TARGET_MODEL=gpt-5.4-nano.
